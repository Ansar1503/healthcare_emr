...
export const authService = {
  login: (
    ...
    AxiosResponse<IApiResponse<{ accessToken: string; user: IUser }>>
  > => api.post("/auth/login", dto),

  logout: (): Promise<AxiosResponse<IApiResponse>> => api.post("/auth/logout"),

  getMe: (): Promise<AxiosResponse<IApiResponse<IUser>>> => api.get("/auth/me"),
};

export const doctorService = {
  getAll: (
    params?: Record<string, unknown>,
  ): Promise<AxiosResponse<IApiResponse<IDoctor[]>>> =>
  ...
  create: (
    dto: ICreateDoctorDTO,
  ): Promise<
    AxiosResponse<
      IApiResponse<{ doctor: IDoctor; user: Pick<IUser, "id" | "email"> }>
    >
...
export const patientService = {
  ...
  create: (
    dto: ICreatePatientDTO,
  ): Promise<AxiosResponse<IApiResponse<IPatient>>> =>
...
export const userService = {
  ...
  toggleActive: (
    id: string,
  ): Promise<AxiosResponse<IApiResponse<{ isActive: boolean }>>> =>
