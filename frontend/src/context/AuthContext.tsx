...
interface AuthContextValue extends IAuthState {
  login: (email: string, password: string) => Promise<{ success: true; role: UserRole } | { success: false; message: string }>;
  logout: () => Promise<void>;
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Listen for forced logout (token refresh failure from api interceptor)
  useEffect(() => {
